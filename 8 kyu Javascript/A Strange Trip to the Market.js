...
function isLockNessMonster(s) {
  ...
  if (
    lowerCaseInput.includes("tree fiddy") ||
    lowerCaseInput.includes("3.50") ||
    lowerCaseInput.includes("three fifty")
  ) {
    return true
  } else {
    return false
